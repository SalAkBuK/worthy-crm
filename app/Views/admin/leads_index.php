  ...
  <div class="col-12">
    <ul class="nav nav-tabs" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#bulk-leads" type="button" role="tab">Bulk Leads</button>
      </li>
      <li class="nav-item" role="presentation">
        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#individual-leads" type="button" role="tab">Individual Leads</button>
      </li>
    </ul>

    <div class="tab-content">
      <div class="tab-pane fade show active" id="bulk-leads" role="tabpanel">
        <div class="card mt-3">
      ...
      <div class="tab-pane fade" id="individual-leads" role="tabpanel">
        <div class="card mt-3">
          <div class="card-header d-flex justify-content-between align-items-center border-bottom">
            <div>
            ...
            <form method="post" action="<?= e(url('admin/leads')) ?>">
              ...
              <div class="table-responsive">
                <table class="table align-middle text-nowrap table-hover table-centered mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td><input class="form-control" name="rows[0][lead_name]"></td>
                      <td><input class="form-control" name="rows[0][contact_email]"></td>
                      <td><input type="tel" class="form-control" name="rows[0][contact_phone]" placeholder="+971 5x xxx xxxx"></td>
                      <td><input class="form-control" name="rows[0][interested_in_property]"></td>
                      <td><input class="form-control" name="rows[0][property_interest_types]" placeholder="Unit, Villa, Land"></td>
                      <td>
                        <select class="form-select" name="rows[0][property_type]">
                          <option value="OFF_PLAN">Off Plan</option>
                          <option value="READY_TO_MOVE">Ready To Move</option>
                        </select>
                      </td>
                      <td><input class="form-control" name="rows[0][area]"></td>
                      <td><input class="form-control" name="rows[0][budget_aed_range]" placeholder="600,000 - 900,000"></td>
                      <td><input class="form-control" name="rows[0][lead_status]"></td>
                      <td>
                        <select class="form-select" name="rows[0][assigned_agent_user_id]">
                          <option value="">Select agent</option>
                          <?php foreach ($agents as $a): ?>
                            <option value="<?= e((string)$a['id']) ?>"><?= e($a['employee_name'] ?: ucfirst($a['username'])) ?></option>
                          <?php endforeach; ?>
